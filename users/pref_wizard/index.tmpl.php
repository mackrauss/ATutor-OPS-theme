...
<!-- Armin changed here themes/default/wizard.css to themes/ocadnew/wizard.css this is not dynamic and seems to be a bad hack         -->
               <!-- Lets just try linking it back to our styles.css for now.... -- joel -- <link rel="stylesheet" href="<?php echo $_base_path; ?>themes/ocadnew/wizard.css" type="text/css" /> -->
<!--    	<link rel="stylesheet" href="<?php echo $this->base_path.'/themes/'.$this->theme; ?>styles.css" type="text/css" /> -->
<!-- Armin changed  -->
		<link rel="stylesheet" href="<?php echo $_base_path; ?>themes/ocadnew/styles.css" type="text/css" />
