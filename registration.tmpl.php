...
<form method="post" action="<?php if (isset($_REQUEST["en_id"]) && $_REQUEST["en_id"] <> "") $getvars = '?en_id='. $_REQUEST["en_id"]; echo $_SERVER['PHP_SELF'] . $getvars; ?>" name="form">
	...
	<div class="input-form">
		...
		<fieldset class="group_form">
			...
			<?php endif; ?>
			<div class="row_explain">
				* = <?php echo _AT('required_field'); ?>
			</div>
		</fieldset>
		...
		<fieldset class="group_form">
			<legend class="group_form"><?php echo _AT('personal_information').' ('._AT('optional').')'; ?></legend>
			<?php 
			...
			<div class="row">
				<fieldset class="group_choice">
					<legend class="group_choice"><?php echo _AT('gender'); ?></legend>
