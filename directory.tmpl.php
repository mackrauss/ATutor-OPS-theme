...
<div class="input-form">
	...
	<div class="row buttons">
		<input type="submit" name="submit"  class="buttons" value="<?php echo _AT('filter'); ?>" />
		<input type="submit" name="reset_filter" class="buttons" value="<?php echo _AT('reset_filter'); ?>" />
	</div>
</div>
</form>
